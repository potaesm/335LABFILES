...
int main(void) {
	...
	DrvSYS_SetClockDivider(E_SYS_HCLK_DIV, 0); /* HCLK clock frequency 
	= HCLK clock source / (HCLK_N + 1) */
	...
	print_lcd(2, "Nu_LB-002       ");	  
	print_lcd(3, "1234567890123456");	  	  
	Timer_initial();
