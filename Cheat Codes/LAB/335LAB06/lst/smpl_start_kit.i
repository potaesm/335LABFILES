...
void InitPWM6(void) {
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPEMFP.PWM6 = 1;
				
	 		
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM67_EN = 1;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2.PWM67_S = 3;
...
void TMR1_IRQHandler(void) {	
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2 = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT << 4;
	sprintf(adc_value+11,"%d   ", ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT);
	...
	sprintf(lcd3_buffer, "T2:0x%x,%d   ", ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TDR, ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TDR);
	print_lcd(3, lcd3_buffer);
	
	if (state == 1) {
			disp2Digit8574_inHex(((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TDR);
		}
	if (state == 2) {
			disp2Digit8574_inDec(((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TDR);
		}
...
void InitTIMER2(void) {	
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.TMR2_S = 2;	
	...
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXCON.TX_PHASE = 1;
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXCON.TCDB = 1;		
	 
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TCSR.CTB = 1; 			
