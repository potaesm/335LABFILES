...
void InitPWM4(void) {
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR0 = 3;		
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 0x3FFF;
...
void InitPWM4fromPWM2(void) {
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 0x1FFF;	
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 0x0FFF;
...
void InitPWM5(void) {
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR1 = 3;		
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1 = 0x3FFF;
...
void TMR3_IRQHandler(void) {	
	...
	clr_all_pannal();
	sprintf(lcd0_buffer+6, " %X", ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0);
...
int32_t main (void) {
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	while (1) {
		...
		if (Scankey() == 4) {
				((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 + 0x100;
				DrvSYS_Delay(300000);
			}
		if (Scankey() == 5) {
				((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 - 0x100;
