...
int8_t OneWireReadByteTemperature(void) {
	int8_t i;	
	int8_t dataByte = 0xCC; 
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT &= 0xFFBF;	
	DrvSYS_Delay(500);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT |= 0x0040;
	DrvSYS_Delay(200);			
	...
	for (i=0;i<8;i++) {
		...
		DrvSYS_Delay(12);
		if ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->PIN &= 0x0040) == 0x0040) {
			dataByte >>= 1;
			dataByte |= 0x80;
		} else {
			dataByte >>= 1;
...
void InitTIMER0(void) {	
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.TMR0_S = 2;	
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TEXCON.TX_PHASE = 1;
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TEXCON.TCDB = 1;		
	 
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR.CTB = 1; 			
...
void TMR3_IRQHandler(void) 		
{
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[0].RSLT << 4;
	
	sprintf(adc0_value+11,"%X   ", ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[0].RSLT);
	print_lcd(0, adc0_value);

	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.ADST = 1;					
	
	sprintf(lcd3_buffer+7, " %d       ", ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TDR);
...
void InitPWM3(void) {
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.PWM23_S = 3;	
...
void InitADC0(void) {
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->OFFD |= 0x00010000;		
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.ADC0 = 1;					
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x1;		
