...
#line 34 "Smpl_Start_Kit.c"
#line 35 "Smpl_Start_Kit.c"
...
#line 38 "Smpl_Start_Kit.c"



#line 57 "Smpl_Start_Kit.c"
...
unsigned char SEG_BUF_HEX[16]={0x82, 0xEE, 0x07, 0x46, 0x6A, 0x52, 0x12, 0xE6, 0x02, 0x62, 0x22, 0x1A, 0x93, 0x0E, 0x13, 0x33}; 
...
void Write_to_any8574(uint8_t i2c_addr, uint8_t data) {
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = i2c_addr;						
...
void out_D2A_8591(uint8_t data) {
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0x90;								
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);	
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0);				
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0x40;								
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);	
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0);				
...
uint8_t Read_A2D_8591(void)	{	
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0;										
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);	
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0);				
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0x91;								
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);	
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0);				
	...
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);	
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0);				
	a2d_value = ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT;
...
void InitADC3(void) {
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->OFFD |= 0x00080000;		
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.ADC3_AD10 = 1;					
				
	           
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.ADC_S = 3;		
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x0008;		
...
void InitCapture2(void) {
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP23 = 11;		
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CAPENR = 4;				
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CAPCH2EN = 1;

	 
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CRL_IE2 = 1;	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CFL_IE2 = 1;	
...
void PWMA_IRQHandler(void) {		
	if (((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PIIR.PWMIF2) {
		CaptureCounter++;						
		if (CaptureCounter == 0) {	
			}
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PIIR.PWMIF2	=	1;			
		}
	if (((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CAPIF2) {
		if (((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CFLRI2) {		
			CaptureValue[0] = CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CFLR2);
			CaptureCounter = 0;				
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CFLRI2 = 0;
		}
		if (((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CRLRI2) {		
			CaptureValue[1] = CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CRLR2);
			CaptureCounter = 0;				
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CRLRI2 = 0;
			}
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR2.CAPIF2 = 1;	
		}
	}
...
void InitTIMER2(void) {
	...
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TCSR.MODE = 2;			
	
	
	
 
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TCSR.PRESCALE = 11;	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TCMPR = 800000;		
...
void TMR2_IRQHandler(void) {	
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT ^= 0x5000;
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TISR.TIF = 1;    		
	}
...
void InitTIMER3(void) {
	...
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TCSR.PRESCALE = 11;	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TCMPR = 1000000;		
...
void TMR3_IRQHandler(void) {	
	...
	sprintf(adc_value+11,"%d   ",((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[3].RSLT);
	
	disp2Digit8574_DEC(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[3].RSLT);
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.ADST = 1;
...
int32_t main() {
  ...
  DrvSYS_Open(48000000);
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	if (DrvUART_Open(UART_PORT2,&sParam) != 0); 
	...
	while(1) {
 	  dataout[7] = 0x30 + i;	
		...
		seg_display(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[3].RSLT);
	}
