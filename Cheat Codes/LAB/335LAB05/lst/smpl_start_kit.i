...
void InitTIMER1(void) {
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCSR.PRESCALE = 11;	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCMPR = 1000000;		
...
void InitTIMER0(void) {
  ...
  ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.TMR0_EN = 1;	
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 300000;		
...
void TMR0_IRQHandler(void) {	
	...
	sprintf(adc_value+11,"%d   ",((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[4].RSLT);
	print_lcd(2, adc_value);
	sprintf(adc_value2+5, "%X %dd    ", ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[4].RSLT, ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[4].RSLT);
	print_lcd(3, adc_value2);
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.ADST = 1;					
	
	if (((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[4].RSLT > 0x250) {
...
void InitADC0(void) {
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x0001;		
...
void InitADC1(void) {
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->OFFD |= 0x00020000;		
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x0002;		
...
void InitADC4(void) {
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->OFFD |= 0x0010000;		
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.ADC4_AD9 = 1;					
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x0010;		
	...
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCMPR[0].CMPD = 0x250;	
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCMPR[0].CMPCH = 4;			
	((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCMPR[0].CMPCOND = 0;		
