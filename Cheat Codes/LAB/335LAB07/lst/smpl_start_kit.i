...
void InitCapture1(void) {
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP01 = 11;		
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR1 = 4;			
									         
	 
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PCR.CH1MOD = 1;		
	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR1 = 0xFFFF;			
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CAPENR = 2;				
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CAPCH1EN = 1;

	 
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CRL_IE1 = 1;	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CFL_IE1 = 1;	
...
void InitCapture5(void) {
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPEMFP.PWM5 = 1;
	...
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP01 = 11;		
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR1 = 4;			
									         
	 
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PCR.CH1MOD = 1;		
	
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR1 = 0xFFFF;			
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CAPENR = 2;				
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CAPCH1EN = 1;

	 
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CRL_IE1 = 1;	
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CFL_IE1 = 1;	
...
void PWMB_IRQHandler(void) {		
	if (((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PIIR.PWMIF1) {
		CaptureCounter++;						
		if (CaptureCounter == 0) {	
			}
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PIIR.PWMIF1	=	1;			
		}
	if (((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CAPIF1) {
		if (((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CFLRI1) {		
			CaptureValue[0] = CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CFLR1);
			CaptureCounter = 0;				
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CFLRI1 = 0;
		}
		if (((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CRLRI1) {		
			CaptureValue[1] = CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CRLR1);
			CaptureCounter = 0;				
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CRLRI1 = 0;
			}
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CCR0.CAPIF1 = 1;	
		}
	}

void InitTIMER0(void) {
	 
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPBMFP.TM0 = 1;				
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR.MODE = 2;			
	
	
	
 
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCSR.PRESCALE = 11;	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 1000000;		
