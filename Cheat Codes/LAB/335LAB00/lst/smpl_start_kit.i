...
int32_t main (void) {
	...
	while(1) {
	  number = Scankey();	
		...
		if (number == 2) {
				(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*E_GPC)) + (0x4*14)))) = 0;
				(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*E_GPC)) + (0x4*15)))) = 0;
			}
			
		if (number == 3) {
				((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT |= 0x1000;
				((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT |= 0xC000;
			}
		...
		if (number == 5) {
			((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT ^= 0x1000;
			DrvSYS_Delay(300000);
			}
			
		if (number == 6) {
			((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT ^= 0x6000;
			DrvSYS_Delay(300000);
			}
